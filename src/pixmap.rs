...
use super::peniko::color::PremulRgba8;
...
impl Pixmap {
    ...
    #[cfg(feature = "png")]
    pub fn from_png(
        data: impl std::io::Read + std::io::BufRead + std::io::Seek,
        ...
        match color_type {
            ...
            png::ColorType::Rgba => {
                debug_assert_eq!(
                    ...
                    reader.output_buffer_size().unwrap_or(0),
            ...
            png::ColorType::GrayscaleAlpha => {
                ...
                let mut grayscale_data = vec![0; reader.output_buffer_size().unwrap_or(0)];
